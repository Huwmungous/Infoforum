...
using FirebirdMcpServer.Protocol;
...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new() { Title = "FirebirdMcpServer API", Version = "v1" });
    });
}
...
app.MapGet("/", () => Results.Json(new { ok = true, server = "FirebirdMcpServer" }));
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "FirebirdMcpServer API v1");
