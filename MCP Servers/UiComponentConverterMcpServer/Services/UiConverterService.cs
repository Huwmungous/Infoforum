...
public class UiConverterService
{
    private readonly ILogger<UiConverterService> _logger;

    public UiConverterService(ILogger<UiConverterService> logger)
    {
        _logger = logger;
    }
    ...
    private List<DelphiComponent> ParseComponents(string content)
    {
    ...
    public ComponentAnalysis AnalyzeUiComponents(DelphiForm form)
    {
        ...
        return new ComponentAnalysis
        {
            ...
            EventHandlers = events.ToList(),
            DataBoundComponents = dataBound
        };
    }

    private void CountComponents(List<DelphiComponent> components, Dictionary<string, int> counts, 
    ...
    private void ExtractHandlersRecursive(List<DelphiComponent> components, HashSet<string> handlers)
    {
        foreach (var component in components)
        {
            foreach (var handler in component.EventHandlers)
    ...
    public string GenerateCssLayout(DelphiForm form)
    {
        return GenerateCss(form);
    }

    private string GenerateCss(DelphiForm form)
    {
    ...
    private string ConvertToReactComponent(DelphiComponent component)
    {
    ...
    private string ConvertToBlazorComponent(DelphiComponent component)
    {
        return component.ComponentType switch
        {
