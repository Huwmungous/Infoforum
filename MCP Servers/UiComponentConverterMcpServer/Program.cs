...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new() { Title = "UiComponentConverterMcpServer API", Version = "v1" });
    });
}
...
app.MapGet("/", () => Results.Json(new { ok = true, server = "UiComponentConverterMcpServer" }));
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "UiComponentConverterMcpServer API v1");
