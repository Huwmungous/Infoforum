...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new() { Title = "GitMcpServer API", Version = "v1" });
    });
}
...
app.MapGet("/", () => Results.Json(new { ok = true, server = "GitMcpServer" }));
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "GitMcpServer API v1");
