...
if (builder.Environment.IsDevelopment())
{
    ...
    {
        c.SwaggerDoc("v1", new() { Title = "DatabaseCompareMcpServer API", Version = "v1" });
    });
}
...
app.MapGet("/", () => Results.Json(new { ok = true, server = "DatabaseCompareMcpServer" }));
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "DatabaseCompareMcpServer API v1");
