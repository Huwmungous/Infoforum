 ...
 * 
 * Examples:
 *   https://longmanrd.net/infoforum/tokens/
 *   https://longmanrd.net/breaktackle/tokens/
 *   http://localhost:5173/infoforum/tokens/
 * 
 ...
 * @returns Base path like "/infoforum/tokens"
 */
export function getAppBasePath(urlConfig: UrlConfig): string {
  return `/${urlConfig.appDomain}/tokens`;
}
 ...
 * @returns Full URL like "https://longmanrd.net/infoforum/tokens/signin/callback"
 */
